...
<head>
    ...
    <link href="{{ asset('marvel2-laravel/public/css/admin.css') }}" rel="stylesheet">
</head>
...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="{{ route('acceder') }}" class="brand-logo" title="Inicio">
            {{ Html::image('marvel2-laravel/public/img/marvelstudios.jpg', 'Logo MarvelStudios') }}
        </a>
        ...
        @if( Auth::check() )
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                @if( Auth::user()->personajes )
                    <li>
                        <a href="{{ url('admin/personajes') }}" title="personajes">Personajes</a>
                    </li>
                @endif
